<div class="relative" wire:click.away="closeDropdown">
    ...
    <div
        ...
        <div class="py-1">
            <a href="<?php echo e(route('export.excel', ['start' => $startDate, 'end' => $endDate])); ?>"
                class="block px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-600 <?php if(!$startDate || !$endDate): ?> opacity-50 pointer-events-none <?php endif; ?>">
                Download Excel (.xlsx)
            </a>
            <a href="<?php echo e(route('export.csv', ['start' => $startDate, 'end' => $endDate])); ?>"
                class="block px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-600 <?php if(!$startDate || !$endDate): ?> opacity-50 pointer-events-none <?php endif; ?>">
                Download CSV (.csv)
            </a>
        </div>
...
</div><?php /**PATH C:\laragon\www\proyek-laporan\resources\views/livewire/download-laporan-button.blade.php ENDPATH**/ ?>