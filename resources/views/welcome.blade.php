                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex justify-between text-center border-t border-slate-200 dark:border-slate-700 pt-4">
                                ...
                                <div class="stat-item">
                                    ...
                                    <p class="text-sm uppercase tracking-wider text-slate-500 dark:text-slate-400">Belum Selesai</p>
                                </div>

                                <div class="stat-item">
                                    <p class="text-3xl font-bold text-sky-500">{{ $mekanik['on_progress'] }}</p>
                    ...
                    <a href="{{ route('maintenance.dashboard', ['keterangan' => 'Elektrik']) }}"
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex justify-between text-center border-t border-slate-200 dark:border-slate-700 pt-4">
                                ...
                                <div class="stat-item">
                                    <p class="text-3xl font-bold text-sky-500">{{ $elektrik['on_progress'] }}</p>
                                    <p class="text-sm uppercase tracking-wider text-slate-500 dark:text-slate-400">On Progress</p>
                                </div>
                                <div class="stat-item">
                    ...
                    <a href="{{ route('maintenance.dashboard', ['keterangan' => 'Utility']) }}"
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex justify-between text-center border-t border-slate-200 dark:border-slate-700 pt-4">
                                ...
                                <div class="stat-item">
                                    <p class="text-3xl font-bold text-sky-500">{{ $utility['on_progress'] }}</p>
                                    <p class="text-sm uppercase tracking-wider text-slate-500 dark:text-slate-400">On Progress</p>
                    ...
                    <a href="{{ route('maintenance.dashboard', ['keterangan' => 'Calibraty']) }}"
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex justify-between text-center border-t border-slate-200 dark:border-slate-700 pt-4">
                                ...
                                <div class="stat-item">
                                    <p class="text-3xl font-bold text-sky-500">{{ $calibraty['on_progress'] }}</p>
                                    <p class="text-sm uppercase tracking-wider text-slate-500 dark:text-slate-400">On Progress</p>
                                </div>
                        ...
                        <div class="swiper-container overflow-hidden" x-ref="container">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide h-auto pb-10">
                                    <div class="report-card bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm shadow-lg border border-slate-200/80 dark:border-slate-700/80 rounded-2xl p-6 flex flex-col h-full hover:shadow-lg hover:shadow-sky-500/20 transition-shadow duration-300">
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex items-center gap-3 min-w-0">
                                                    ...
                                                    <div class="w-10 h-10 rounded-full bg-yellow-100 dark:bg-yellow-500/20 flex items-center justify-center flex-shrink-0">
                                                        <svg class="w-5 h-5 text-yellow-500 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <div class="w-10 h-10 rounded-full bg-red-100 dark:bg-red-500/20 flex items-center justify-center flex-shrink-0">
                                                        <svg class="w-5 h-5 text-red-500 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <div class="w-10 h-10 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center flex-shrink-0">
                                                        <svg class="w-5 h-5 text-green-500 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
