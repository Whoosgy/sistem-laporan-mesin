        ...
        <div class="w-full max-w-5xl mx-auto">
            ...
            <div class="mt-12">
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
                   {{-- Card Pending --}}
                    <a class="group block text-center bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-10 transform transition-all duration-300 ease-in-out shadow-lg hover:shadow-2xl hover:-translate-y-2 hover:border-amber-500">
                    ...
                    {{-- Card Belum Selesai --}}
                    <a class="group block text-center bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-10 transform transition-all duration-300 ease-in-out shadow-lg hover:shadow-2xl hover:-translate-y-2 hover:border-sky-500">
                        <div class="flex justify-center mb-4">
                            <div class="p-3 bg-sky-100 dark:bg-sky-900/50 rounded-full">
                        ...
                        <p class="text-7xl font-bold text-sky-500">{{ $belumSelesaiCount }}</p>
                        <p class="text-base text-slate-400 mt-4">Laporan</p>
                    </a>

                    {{-- Card Selesai --}}
                    <a class="group block text-center bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-10 transform transition-all duration-300 ease-in-out shadow-lg hover:shadow-2xl hover:-translate-y-2 hover:border-emerald-500">
                        <div class="flex justify-center mb-4">
