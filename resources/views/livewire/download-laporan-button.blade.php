<div class="relative" wire:click.away="closeDropdown">
    <button wire:click="toggleDropdown" type="button" class="inline-flex items-center gap-x-2 rounded-md bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
    ...
    >
        ...
        <div class="p-2 space-y-2 border-b border-slate-200 dark:border-slate-600">
            <div>
                ...
                <input wire:model.live="startDate" type="date" id="startDate" class="mt-1 block w-full rounded-md border-slate-300 dark:bg-slate-800 dark:border-slate-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
            <div>
                <label for="endDate" class="block text-xs font-medium text-slate-600 dark:text-slate-300">Tanggal Selesai</label>
                <input wire:model.live="endDate" type="date" id="endDate" class="mt-1 block w-full rounded-md border-slate-300 dark:bg-slate-800 dark:border-slate-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
        </div>
        <div class="py-1">
