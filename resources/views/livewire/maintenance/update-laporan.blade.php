            ...
            <form wire:submit.prevent="updateLaporan">
                ...
                <div class="p-6 space-y-4 text-sm max-h-[70vh] overflow-y-auto">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="relative mt-1">
                                ...
                                <div x-show="open" style="display: none;" class="absolute z-10 w-full mt-1 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md shadow-lg max-h-40 overflow-y-auto">
                                    @foreach(['Pending', 'On Progress', 'Belum Selesai', 'Selesai'] as $statusOption)
                                        <div @click="selected = '{{ $statusOption }}'; open = false" class="cursor-pointer px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700">{{ $statusOption }}</div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div x-data="{ open: false, selected: @entangle('keterangan_maintenance') }" @click.away="open = false">
                            ...
                            <div class="relative mt-1">
                                ...
                                <div x-show="open" style="display: none;" class="absolute z-10 w-full mt-1 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md shadow-lg max-h-32 overflow-y-auto">
                                    ...
                                    <div @click="selected = '{{ $keterangan }}'; open = false" class="cursor-pointer px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700">{{ $keterangan }}</div>
                                    @endforeach
                                </div>
                            </div>
