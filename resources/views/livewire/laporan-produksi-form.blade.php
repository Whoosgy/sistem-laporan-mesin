...
<div>
    ...
    {{-- Form membungkus Card Input dan juga Modal --}}
    <form wire:submit.prevent="save">

        {{-- Grid utama untuk dua kartu yang tersusun vertikal --}}
        <div class="space-y-8">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
                ...
                <div class="p-5 space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div x-data="{ open: false, search: @entangle('shift') }" @click.away="open = false">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div x-data="{ open: false, search: @entangle('keterangan') }" @click.away="open = false">
                   ...
                   <div class="bg-slate-50 dark:bg-slate-800/50 px-5 py-3 flex justify-end items-center space-x-2">
                    ...
                    <button type="button" wire:click="openConfirmationModal" class="ml-2 px-3 py-2 text-xs font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700">
                        Lihat & Kirim Laporan
                    </button>
                </div>
            </div>
        ...
        >
            ...
            <div x-show="show" x-transition class="relative w-full max-w-lg m-8 bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-slate-200 dark:border-slate-700">
                ...
                <div class="p-6 space-y-2 text-sm max-h-96 overflow-y-auto">
                    <div class="flex justify-between py-2 border-b border-slate-200 dark:border-slate-700">
                        ...
                        <div class="flex justify-between py-2 border-b border-slate-200 dark:border-slate-700">
                            ...
                            <span class="font-semibold text-slate-600 dark:text-slate-200">{{ $keterangan ?? '___' }}</span>
                        </div>
                        <div>
                ...
                <button type="button" wire:click="closeModal" class="px-4 py-2 text-sm font-medium text-slate-600 bg-white border border-slate-300 rounded-md shadow-sm hover:bg-slate-50">
                    ...
                    {{-- Tombol Kirim final ada di sini --}}
    ...
    <tr class="text-left">
        <th class="px-5 py-3 font-medium text-slate-600 dark:text-slate-300 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700" wire:click="sortBy('tanggal_lapor')">
            <div class="flex items-center">
                ...
                {{-- PERBAIKAN: Ikon panah sekarang selalu muncul --}}
                <span class="ml-2">
                    @if($sortField === 'tanggal_lapor' && $sortDirection === 'asc')
                        <span>&uarr;</span> {{-- Panah Atas --}}
                    @else
                        <span>&darr;</span> {{-- Panah Bawah (default) --}}
                    @endif
                </span>
            </div>
        </th>
        <th class="px-5 py-3 font-medium text-slate-600 dark:text-slate-300 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700" wire:click="sortBy('nama_mesin')">
            <div class="flex items-center">
                ...
                {{-- Ikon hanya muncul jika kolom ini aktif --}}
